...
export default function QuoteForm() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      {/* TEXTE INTRO */}
      <h1 className="text-3xl font-bold text-center mb-4 max-w-2xl mx-auto">
      ...
      <div className="max-w-lg mx-auto bg-white p-6 rounded-xl shadow">
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
          ...
          <input name="postalCode" required placeholder="Code postal"
            className="w-full border rounded-lg p-3 focus:ring-2 focus:ring-gray-400 focus:outline-none" />
          ...
          <input name="brand" required placeholder="Marque"
            className="w-full border rounded-lg p-3 focus:ring-2 focus:ring-gray-400 focus:outline-none" />

          <input name="model" required placeholder="Modèle"
            className="w-full border rounded-lg p-3 focus:ring-2 focus:ring-gray-400 focus:outline-none" />

          <input name="year" required placeholder="Année"
            className="w-full border rounded-lg p-3 focus:ring-2 focus:ring-gray-400 focus:outline-none" />
